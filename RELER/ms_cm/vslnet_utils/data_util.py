...
def time_to_index_cheap(start_time, end_time, num_units, duration):
    start_index = int(np.rint(start_time / duration * num_units).item())
    end_index = int(np.rint(end_time / duration * num_units).item())
